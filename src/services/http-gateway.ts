...
class HttpGateway {
    ...
    getThreatModel = async () => {
        return new Promise<GatewayResponse>((resolve, reject) => {
            ...
            //     .then(results => {
            //         if(results.threatModel) {
            //             resolve({
            //                 success: true,
            //                 data: results.threatModel
            //             });
            //         } else {
            //             reject({
            //                 success: false,
            //                 error: 'unable to load threat model data'
            //             });
            //         }
            //     })
            //     .catch(caught => {
            ...
            //         reject({
            //             success: false,
            //             error: 'failed to load threat model data'
            //         });
            //     });

            //
            // Dummy threat model data
            //
    ...
    // This returns a list of the countries with no additional includes.
    getCountries = async () => {
        return new Promise<GatewayResponse>((response) => {
            ...
            //             reject({
            //                 success: false,
            //                 error: 'unable to load countries data'
            //             });
            //         }
            //     })
            //     .catch(caught => {
    ...
    //  once a country is selected the threat assessment for that country will be displayed.
    //  country assessment
    getCountriesAFG = async () => {
        return new Promise<GatewayResponse>((response) => {

            // fetch('/countries/AFG?include=assessment', {
            //     method: 'get'
            // })
            //     .then(response => response.json())
            //     .then(results => {
            //         if(results.threatAssessment) {
            //             resolve({
            //                 success: true,
            //                 data: results.threatAssessment
            //             });
            //         } else {
            //             reject({
            //                 success: false,
            //                 error: 'unable to load countries-afg data'
            //             });
            //         }
            //     })
            //     .catch(caught => {
            ...
            //         reject({
            //             success: false,
            //             error: 'failed to load countries-afg data'
            //         });
            //     });

            //
            // Dummy countries-afg data
            //
    ...
    getCountriesIDN = async () => {
        return new Promise<GatewayResponse>((response) => {

            // fetch('/countries/IDN?include=assessment', {
            //     method: 'get'
            // })
            //     .then(response => response.json())
            //     .then(results => {
            ...
            //             reject({
            //                 success: false,
            //                 error: 'unable to load countries-idn data'
            //             });
            //         }
            //     })
            //     .catch(caught => {
            ...
            //         reject({
            //             success: false,
            //             error: 'failed to load countries-idn data'
            //         });
            //     });

            //
            // Dummy countries-idn data
            //
